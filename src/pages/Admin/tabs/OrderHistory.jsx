...
const OrderHistory = () => {
  ...
  useEffect(() => {
    ...
    // Show both completed (from KDS) and delivered orders in history
    const q = query(
      ordersRef,
    ...
    const unsubscribe = onSnapshot(
      ...
      (snapshot) => {
        ...
        // Client-side sort by createdAt desc to avoid composite index errors
      ...
      {isLoading ? (
        ...
        <div className="py-20 text-center bg-[#2A2A2D] rounded-[40px] border border-dashed border-white/5">
          ...
          <p className="text-gray-500 text-sm mt-1">
            Check back once the kitchen starts delivering!
          </p>
        </div>
      ) : (
              ...
              <div className="flex items-center gap-6 flex-1">
                ...
                <div>
                  <div className="flex items-center gap-3 mb-1">
                    <span className="text-[#6539A3] font-black tracking-wider">
